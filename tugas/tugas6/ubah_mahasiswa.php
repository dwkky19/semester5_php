            ...
            <tr>
                ...
                <td>
                    <input type="radio" name="jekel" value="L"
                        <?php if ($d['jns_kelamin'] == 'L') echo 'checked'; ?>>Laki-laki
                    <input type="radio" name="jekel" value="P"
                        <?php if ($d['jns_kelamin'] == 'P') echo 'checked'; ?>>Perempuan
                </td>
            </tr>
            <tr>
                <td>Jurusan</td>
                <td>
                    <select name="jurusan">
                        ...
                        <option value="SIA" <?php if ($d['jurusan'] == "SIA") echo 'selected="selected"'; ?>>SIA
                        </option>
                    </select>
                </td>
            </tr>
